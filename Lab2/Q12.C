...
#define PORT_NUMBER 12754 // Usa un numero del 1-4 y luego tus últimos 4 dígitos del numero de estudiante
...
void server()
{
    ...
    while (!serverShutdown)
    {
        ...
        else if (forkPID == 0)
        {
            ...
            close(message_socket); // Close socket used for message
    }
    // Close socket
    close(server_socket);
}
